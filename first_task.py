...
class TestAddingToCommentsList(unittest.TestCase):
    def setUp(self):
        ...
        self.driver = webdriver.Chrome(
            executable_path="C:\Program Files (x86)\Python36-32\Scripts\chromedriver.exe")
    ...
    def test_adding_to_comments_list(self):
        ...
        self.driver.find_element_by_xpath('//*[@id="main"]/div/div[5]/form/table/tbody/tr[1]/td[1]/input[1]').click()
